...
def selection_app():
    ...
    if symbol and period and benchmark_condition:
        ...
        try:
            ...
            img_file2 = "Oops! Image not available. We will try to rectify this soon."
        ...
        try:
            ...
            img_file1 = "Oops! Image not available. We will try to rectify this soon."
